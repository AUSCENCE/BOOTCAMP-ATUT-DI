...
task = Task(
    ...
    expected_output=(
        "Un objet JSON structuré avec la clé 'sites_touristiques'. Chaque entrée doit inclure le nom du site, une description succincte, l'adresse, et des liens vers des vidéos et des images. "
        "Le JSON doit refléter toutes les données pertinentes collectées sur chaque site."
    ),
    agent=agent_collect
)
